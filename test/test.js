...
describe('Points', function() {
  var _generate_points = require('../lib/points').generate_grid;
  describe('#_generate_points', function() {
    it('generates points', function() {
        ...
        var generatedPoints = _generate_points(width, height, bleed_x, bleed_y, cell_size, variance, rand_fn);

        generatedPoints.should.be.instanceof(Float64Array);
    });
  });
});
